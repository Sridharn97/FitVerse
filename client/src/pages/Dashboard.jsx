...
const Dashboard = () => {
  ...
  const customDays = customDaysStr ? JSON.parse(customDaysStr) : ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  const display7Days = last7Days.filter(d => customDays.includes(d.label));
